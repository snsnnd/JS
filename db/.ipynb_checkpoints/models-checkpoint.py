from sqlalchemy import Column, Integer, String, Float, Numeric, ForeignKey, DateTime, Enum, Text, func
...
class User(Base):
    ...
    psych_status = Column(String(50), nullable=True, default="良好")
...
class AIAnalysisResult(Base):
    ...
    # 【✅ 修复致命Bug】改为 Float，支持类似 15.5 周的最佳检测时间，防止存入数据库报错
...
class Appointment(Base):
    ...
    # 【✅ 修复致命Bug】因为顶部引入了 func，这里才能正常使用 func.now()
